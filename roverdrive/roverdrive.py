...
MISSION_FOLDER = "lib/roverdrive/backgrounds/training/"
...
def _moveToNewPosition(new_pos):
    ...
    svg_path += "L {x2:.2f},{y2:.2f} ".format(x2 = new_pos[0], y2 = new_pos[1])
...
class Missions(object):
    ...
    def bg_file(self):
        if self.current_mission not in self.start_pos.keys(): 
            ...
            return self.folder + "{:0>3}.jpeg".format(self.current_mission)
